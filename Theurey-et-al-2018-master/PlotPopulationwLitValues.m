...
varNameAll = {'baselinePHx' 'baselineTMRM' 'baselineATPc' };
...
for figureNum = 1:3
    ...
    % end
    if strcmp(varName, 'baselinePHx')
        plotValue = baselinePHx;
    elseif strcmp(varName, 'baselineTMRM')
        plotValue = baselineTMRM;
    elseif strcmp(varName, 'baselineATPc')
        plotValue = baselineATPc;
    end 
    ...
    legend('Model sims', 'Lit. range', 'Location', 'southoutside', 'NumColumns',2)
    %%