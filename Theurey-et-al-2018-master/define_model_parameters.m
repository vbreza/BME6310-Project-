...
%*************************************************************************
xpar(9) = 1.0200e+003; %* 1.1;  %1.0200        % x_C1       % Complex I activity
%*************************************************************************
% FLUX 3: Parameter for complex III
%*************************************************************************
xpar(10) = 0.2241; %* 1.1;    %0.2241          % x_C3      % Complex III activity
xpar(11) = 0.192e-3; %* 1.1;   %0.192e-3         % k_Pi3     % Complex III / Pi parameter
xpar(12) = 25.31e-3; %* 1.1;    %25.31e-3        % k_Pi4     % Complex III / Pi parameter
%*************************************************************************
% FLUX 4: Parameter for complex IV
%*************************************************************************
xpar(13) = 3.2131e-004; %* 1.1;  %3.2131e-004       % x_C4      % Complex IV activity
xpar(14) = 1.2e-4; %* 1.1;       %1.2e-4       % k_O2      % kinetic constant for complex IV (M)
%*************************************************************************
...
%*************************************************************************
xpar(21) = 150;      %150         % x_Hle     % Proton leak activity  
%*************************************************************************
